...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    { path: '/academic/conferences', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/academic/dissertations', priority: 0.7, changeFrequency: 'monthly' as const },
    { path: '/academic/orations', priority: 0.7, changeFrequency: 'monthly' as const },
