...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Dr Debashish Chowdhury Neurologist",
    "best neurologist in Delhi",
    "top neurologist in India",
    "best headache specialist in Delhi",
    "top headache doctor in Delhi NCR",
    "headache specialist near me",
    "migraine treatment in Delhi",
    "best migraine doctor in India",
    "stroke specialist in Delhi",
    "best epilepsy doctor in Delhi",
    "epilepsy care",
    "Alzheimer's care",
    "Parkinson's disease treatment",
    "neurodegenerative disorders",
    "neurology clinic in Karol Bagh",
    "neurologist in Karol Bagh",
    "BLK-Max Hospital neurologist",
    "vertigo treatment",
    "dementia specialist",
    "movement disorders specialist",
    "neuropathy treatment",
    "brain doctor in Delhi",
    "top neuro physician in India",
    "neurologist near me",
    "Headache Specialist India",
    "Migraine Treatment",
    "Best Neurologist",
    "Headache Doctor",
